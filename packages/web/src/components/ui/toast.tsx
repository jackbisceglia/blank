...
export const ToastContent = (props: ComponentProps<'div'>) => {
  ...
  return (
    <div class={cn('flex w-full flex-col', local.class)} {...rest}>
      ...
      <ToastPrimitive.CloseButton class="absolute right-1 top-1 rounded-md p-1 text-ui-foreground/50 opacity-0 transition-opacity hover:text-ui-foreground focus:opacity-100 focus:outline-none group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50">
        <svg
...
export const ToastProgress: VoidComponent = () => {
  return (
    <ToastPrimitive.ProgressTrack class="h-1 w-full overflow-hidden rounded-xl bg-ui-primary/20 group-[.destructive]:bg-ui-background/20">
      <ToastPrimitive.ProgressFill class="h-full w-[--kb-toast-progress-fill-width] bg-ui-primary transition-all duration-150 ease-linear group-[.destructive]:bg-ui-destructive-foreground" />
