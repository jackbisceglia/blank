    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          "[&:has([aria-selected])]:bg-secondary/20",
        ...
        day_range_end:
          "day-range-end aria-selected:bg-primary aria-selected:text-primary-foreground aria-selected:hover:bg-primary aria-selected:hover:text-primary-foreground",
        day_selected:
        ...
        day_range_middle:
          "aria-selected:bg-secondary/15 aria-selected:text-foreground",
