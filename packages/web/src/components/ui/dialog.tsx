  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay
        class={cn(
          'fixed inset-0 z-50 bg-ui-background/90 data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0',
        )}
        {...rest}
      />
      ...
      >
        {local.children}
        <DialogPrimitive.CloseButton class="absolute right-4 top-4 opacity-70 ring-offset-ui-background transition-[opacity,box-shadow] hover:opacity-100 focus:outline-none focus:ring-[1.5px] focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
          <svg
...
export const DialogTitle = <T extends ValidComponent = 'h2'>(
  ...
  return (
    <DialogPrimitive.Title
      class={cn('text-lg font-semibold text-ui-foreground', local.class)}
      {...rest}
    />
  );
};
...
export const DialogDescription = <T extends ValidComponent = 'p'>(
  ...
  return (
    <DialogPrimitive.Description
      class={cn('text-sm text-ui-muted-foreground', local.class)}
      {...rest}
    />
  );
};
...
export const DialogFooter = (props: ComponentProps<'div'>) => {
  ...
  return (
    <div
      class={cn('flex flex-col sm:justify-end w-full gap-2', local.class)}
      {...rest}
    />
  );
};
