  ...
  return (
    <AlertDialogPortal>
      ...
      >
        {children}
        {!omitCloseButton && (
          <AlertDialogCancel className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none bg-transparent border-0 p-0 h-auto shadow-none hover:bg-transparent hover:text-current">
