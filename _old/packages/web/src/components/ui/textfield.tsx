...
export const textfieldLabel = cva(
  'text-sm data-[disabled]:cursor-not-allowed data-[disabled]:opacity-70 font-medium',
  {
    variants: {
      label: {
        true: 'data-[invalid]:text-ui-destructive',
      },
      error: {
        true: 'text-ui-destructive text-xs',
      },
      description: {
        true: 'font-normal text-ui-muted-foreground',
      },
    },
    defaultVariants: {
      label: true,
